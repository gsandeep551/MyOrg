...
const INITIAL: MultiSelectOption[] = [
  {
    ...
    description: 'Layouts, systems, polish',
    group: 'Design',
    icon: '🎨',
    tint: '#FDE7E1',
  },
  {
    value: 'motion',
    label: 'Motion',
    description: 'Springs, easing, choreography',
    group: 'Design',
    icon: '🌀',
    tint: '#E4ECFF',
  },
  {
    value: 'type',
    label: 'Typography',
    description: 'Type scales and pairing',
    group: 'Design',
    icon: '🔤',
    tint: '#F1EAFE',
  },
  ...
  },
  {
    value: 'ts',
    label: 'TypeScript',
    description: 'Types all the way down',
    group: 'Engineering',
    icon: '🟦',
    tint: '#E1EAFB',
  },
  ...
  },
  {
    value: 'cobol',
    label: 'COBOL',
    description: 'Retired from this list',
    group: 'Engineering',
    icon: '📼',
    disabled: true,
  },
    ...
    <SafeAreaProvider>
      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.content}>
          <Text style={[styles.h1, dark ? styles.inkDark : styles.inkLight]}>
            Your profile
          </Text>
...
const styles = StyleSheet.create({
  root: { flex: 1 },
  rootLight: { backgroundColor: '#F6F5F2' },
  rootDark: { backgroundColor: '#0E0E14' },
  inkLight: { color: '#16161D' },
  inkDark: { color: '#F2F2F7' },
